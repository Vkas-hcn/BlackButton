package com.blackbutton.fast.tool.secure.ad
        ...
        InterstitialAd.load(
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdFailedToLoad(adError: LoadAdError) {
                    ...
                    LiveEventBus.get(Constant.PLUG_ADVERTISEMENT_CACHE).post(null)
                }

                override fun onAdLoaded(interstitialAd: InterstitialAd) {
                    mInterstitialAd = interstitialAd
                    LiveEventBus.get(Constant.PLUG_ADVERTISEMENT_CACHE).post(interstitialAd)
                }
            })
    }
